...
describe('ShapeFactory', () => {
  ...
  test('should throw error for unknown type', () => {
    expect(() => ShapeFactory.create('hexagon', {}))
      .toThrow();
  });
});
...
describe('Factory', () => {
  ...
  describe('validation', () => {
    test('should validate required fields', () => {
      ...
      expect(() => factory.create('user', { name: 'Alice' }))
        .toThrow();

      const user = factory.create('user', { name: 'Alice', email: 'alice@example.com' });
    ...
    test('should run custom validation', () => {
      ...
      expect(() => factory.create('adult', { name: 'Kid', age: 10 }))
        .toThrow();
